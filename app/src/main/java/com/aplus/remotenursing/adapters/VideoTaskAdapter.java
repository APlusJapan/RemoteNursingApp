...
public class VideoTaskAdapter extends RecyclerView.Adapter<VideoTaskAdapter.SeriesViewHolder> {
    ...
    public VideoTaskAdapter(List<VideoTask> seriesList, OnSeriesClickListener listener) {
        this.seriesList = seriesList;
        this.listener = listener;
    }

    public void setSeriesList(List<VideoTask> list) {
    ...
    public SeriesViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.item_video_task, parent, false);
